...
const Logo = () => (
  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
    <div style={{ width: '3.25rem', height: '3.25rem', borderRadius: '0.75rem', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 24px rgba(0,0,0,0.08)' }}>
      <span style={{ color: '#4a7300', fontWeight: 700, fontSize: '1.2rem' }}>SB</span>
    </div>
    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      <span style={{ fontSize: '1rem', fontWeight: 700, letterSpacing: '0.02em', color: '#fff' }}>SmallBasket</span>
      <span style={{ fontSize: '0.86rem', color: 'rgba(255,255,255,0.85)' }}>Smart Grocery Checkout</span>
    </div>
  </div>
)
